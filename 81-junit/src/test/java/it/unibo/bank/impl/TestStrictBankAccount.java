...
public class TestStrictBankAccount {
    ...
    public void testManagementFees() {
        ...
        double expectedNewBalance = INITIAL_AMOUNT - MANAGEMENT_FEE - (bankAccount.getTransactionsCount() * TRANSACTION_FEE);
        bankAccount.chargeManagementFees(mRossi.getUserID());
        Assertions.assertEquals(expectedNewBalance, bankAccount.getBalance());
        Assertions.assertEquals(0, bankAccount.getTransactionsCount());
    }
